...
import { Coins, Users, ChevronRight, TrendingUp, BookOpen, Search, X, MessageSquareMore, LogIn, Trophy, FolderKanban, ClipboardList } from "lucide-react";
      ...
      <header className="bg-[#FFD700] border-b-4 border-black p-6 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <HeaderMenu items={[
            ...
            { label: "Testlar", icon: <ClipboardList size={18} />, to: "/tests" },
