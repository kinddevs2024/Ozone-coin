...
import { Coins, ClipboardList, History, Home, Scale, LogOut, Settings, Trophy, FolderKanban } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#f5f5f5] pb-20">
      ...
      <main className="max-w-4xl mx-auto p-6 space-y-6">
        <div className="flex flex-nowrap overflow-x-auto gap-2 pb-1 md:flex-wrap md:overflow-visible">
          ...
          <NavLink to="/works" label="Ishlar" icon={<FolderKanban size={14} />} />
